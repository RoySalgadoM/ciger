...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: '20203tn052@utez.edu.mx',
        pass: 'chanclavoladora'
    }
});
...
router.post('/mail',async(req,res)=>{
    ...
    let code = Math.floor(Math.random()*11)
    for(i=0;i<3;i++){
        code = `${code}${Math.floor(Math.random()*11)}`;
    }
    const mailOptions = {
        to: email,
        ...
        * {
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="padding-right: 0px;padding-left: 0px;" align="center">
              ...
              <img align="center" border="0" src="images/image-1.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 23%;max-width: 133.4px;" width="133.4"/>
        ...
        <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="color: white; line-height: 140%; text-align: center; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 26px; line-height: 36.4px;"><strong><span style="line-height: 36.4px; font-size: 26px;">Confirma tu correo electr&oacute;nico</span></strong></span></p>
          </div>
        ...
        <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="color: white; line-height: 210%; text-align: center; word-wrap: break-word;">
            <p style="line-height: 210%; color:white; font-size: 14px;"><span style="font-size: 16px; line-height: 33.6px;">Para completar tu registro ingresa el siguiente c&oacute;digo: </span></p>
            <p style="line-height: 210%; font-size: 14px;"><span style="font-size: 16px; line-height: 33.6px;">${code}</span></p>
          </div>
...
router.post('/recover',async(req,res)=>{
  res.setHeader('Access-Control-Allow-Origin', '*');
  const {email} = req.body;
  let user = await pool.query('SELECT idUser FROM USER WHERE email=?', [email]);
  let code = Math.floor(Math.random()*11)
  for(i=0;i<3;i++){
      code = `${code}${Math.floor(Math.random()*11)}`;
  }
  const mailOptions = {
      ...
      * {
      ...
      <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div style="color: white; line-height: 140%; text-align: center; word-wrap: break-word;">
          <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 26px; line-height: 36.4px;"><strong><span style="line-height: 36.4px; font-size: 26px;">Recupera tu contraseña</span></strong></span></p>
        </div>
      ...
      <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div style="color: white; line-height: 210%; text-align: center; word-wrap: break-word;">
          <p style="line-height: 210%; color:white; font-size: 14px;"><span style="font-size: 16px; line-height: 33.6px;">Para recuperar tu contraseña ingresa el siguiente código</span></p>
          <p style="line-height: 210%; font-size: 14px;"><span style="font-size: 16px; line-height: 33.6px;">${code}</span></p>
        </div>
